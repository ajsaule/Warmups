...
//     var firstPartOfName = thisArray[Math.floor(Math.random() * thisArray.length)];
//     var secondPartOfName = thatArray[Math.floor(Math.random() * thatArray.length)];
//     console.log(`${firstPartOfName} ${secondPartOfName}`)
// }

// console.log(randomNameGenerator());

function randomArrayNameGenerator(firstName, secondName) {
    console.log(
        firstName[Math.floor(Math.random() * thisArray.length)]
        + ' ' +
        secondName[Math.floor(Math.random() * thatArray.length)]
    );
}

console.log(randomArrayNameGenerator(thisArray, thatArray));